...
class JugadoresService {
    ...
    fun agregarJugador(
        ...
        val sql = """
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW(), ?)
        """
        jdbcTemplate.update(sql, nombre, n_documento, fecha_nacimiento, email, password, genero, edad, user_id, equipo_id)
    }
    ...
    fun actualizarJugador(
        ...
        val sql = """
            ...
            WHERE id = ?
        """
        jdbcTemplate.update(sql, nombre, n_documento, fecha_nacimiento, email, password, genero, edad, user_id, equipo_id, id)
    }
